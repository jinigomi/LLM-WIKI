...
LLM이 입력 컨텍스트 길이가 길어질수록 성능이 저하되는 현상. 긴 컨텍스트를 균등하게 처리하지 못하며, 의미적 검색에서 특히 두드러짐. 긴 프롬프트일수록 중간 부분의 정보를 놓치는 "lost-in-the-middle" 현상과 밀접하게 연관된다.
...
- [[long-running-agents]] — Context Rot를 Fresh Context Windows로 해결하는 Long-Running Agent 패턴