---
source_url: https://drive.google.com/file/d/1JkNUDOztGVX7LLbMgkiOr0vffBLg8PeU/view
ingested: 2026-05-01
sha256: 3cc6d68d79aaaf25ce8408f5e07afcbf6080e398230fa7d8cdd419d9e0270bcf
source_drift_note: Google Drive — no web fetch, manual re-check only
---
...
**Pages:** 23  
**Topics:** Python, LLM, Frameworks, Memory, Tools, RAG, Agents, Deployment  
...
4
4
Pick a Framework (LangChain/LangGraph vs CrewAI vs AutoGen)
6
5
Advanced Framework Concepts (LCEL, Runnables, Workflows, Multi-Agent)
8
6
Memory Management (Short-Term, Long-Term, Checkpointing)
10
7
Tool Integration (Custom Tools, Connectors, Decorators)
12
8
RAG Systems (Vector Stores, Embeddings, Retrieval Strategies)
14
9
...
typed interfaces, and unit/integration tests. The goal is separations of concerns so prompts/tools
...
repeats until a stop condition. For agents, the key is that “reasoning” is pattern-based prediction,
...
how to handle uncertainty). Good prompts reduce ambiguity and make failure modes predictable.
...
Answer: Temperature controls randomness; higher means more diverse outputs. Top-p (nucleus
...
Answer: Start from requirements: deterministic workflows vs conversational autonomy, number
...
behind an API. Introduce typed schemas, error handling, retries, and rate limits. Add evaluation
...
Use embeddings for large knowledge where you need semantic retrieval (notes, docs, past tickets).
...
verified facts; private memory might include a specialist agent’s intermediate notes.
Use
10
...
loops where hallucinations get stored as memory.
Also: stale preferences and conflicting
...
format. Avoid passing huge raw context; pass references and summaries. Enforce role boundaries
