...
- [[flashqla]] — Qwen FlashQLA: TileLang 기반 고속 linear attention kernel (GDR forward 2-3×, backward 2× speedup)
...
- `raw/notebooklm-vibe-coding-report` — NotebookLM 바이브 코딩 리포트
